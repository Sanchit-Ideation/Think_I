...
const recentAlerts = [
  {
    type: "warning",
    message: "Unusual activity detected in Software Engineer interviews",
    time: "2h ago",
  },
  {
    type: "info",
    message: "New competency model available for Product Manager role",
    time: "4h ago",
  },
  {
    type: "success",
    message: "Monthly hiring target achieved (97/95)",
    time: "1d ago",
  },
];
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-lg bg-${metric.color}-500/10`}>
                  <IconComponent
                    className={`w-6 h-6 text-${metric.color}-500`}
                  />
                </div>
              </div>
            </div>
                  ...
                  <td className="py-3 px-4">
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${
                        interviewer.missed_elements <= 3
                          ? "bg-green-500/10 text-green-600"
                          : interviewer.missed_elements <= 5
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-foreground text-sm">
                        {template.recommended_pct}%
                      </span>
                    </div>
                  </td>
                  <td className="py-3 px-4 text-muted-foreground">
                    {template.integrity_score}
                  </td>
                  <td className="py-3 px-4 text-muted-foreground">
                    {template.avg_score}
                  </td>
                  <td className="py-3 px-4">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${
                        template.recommended_pct >= 75
                          ? "bg-green-500/10 text-green-500"
                          : template.recommended_pct >= 65
